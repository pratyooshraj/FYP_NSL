...
# Load the video
video_path = 'Dataset/Videos/NSL_Vowel/S3_NSL_Vowel_Prepared/S3_NSL_Vowel_Prepared_Camera_all.mov'  # Update with the actual path to your video file
...
while True:
    ...
    # Adjust the delay for 0.75x speed
    key = cv2.waitKey(int(1000 / (fps * 1))) & 0xFF  # Adjust the delay for 0.75x speed
